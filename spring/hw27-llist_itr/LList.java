   ...
   *****************************************************/
	...
	*/
	if (_dummy==null && _head != null)
	  ...
	  //relies on hasNext method to get next value
	  if(!hasNext())
    ...
    public void remove() 
    {
      ...
      //      
	    //if ________...
	        ...
	        _prev.setNext(_dummy.getNext());
	    }
	    _dummy = _prev;

	    //Q: Anything else need to be done?
	    //still doesnt recognize as iterable!
